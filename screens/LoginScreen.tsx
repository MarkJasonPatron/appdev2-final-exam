...
import { useNavigation } from "@react-navigation/native"; // Added for navigation logic
...
const LoginScreen = ({ onLogin } : LoginProps) => {
    ...
    const handleLogin = async () => {
        if (!email || !password) {
            ...
            return; // Added return to prevent execution if fields are empty
        }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.formContainer}>
                ...
                <TextInput 
                    ...
                    autoCapitalize="none" // Added to prevent unwanted capitalization
                />
...
const styles = StyleSheet.create({
    ...
    illustration: {
        width: "80%",
        height: "70%",
        resizeMode: "contain", // Added to ensure image fits properly
    },
    formContainer: {
        flex: 2,
        backgroundColor: "#FFF",
